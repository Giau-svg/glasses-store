        ...
        <div class="brands-img__wrap">
            <a href="view_brand.php?id=3" class="brands__img">
                ...
                <div class="slider-caption">
                    ...
                    <p>Khám phá bộ sưu tập Gucci mới</p>
                </div>
            </a>
        </div>
        <div class="brands-img__wrap">
            <a href="view_brand.php?id=2" class="brands__img">
                <img src="public/img/Matkinh-Rayban.jpg" alt="Prada Slide 1">
                <div class="slider-caption">
                    <h3>RayBan - Đẳng cấp thời thượng</h3>
