    ...
    <div class="sidebar__category" style="min-width: 0; max-width: 100%;">
        ...
        <form method="get" action="search.php" style="padding: 0 10px 10px 10px;">
            <div class="sidebar__filter-group">
                ...
                <input type="text" name="search" id="search" class="sidebar__filter-select" style="width: 100%; padding: 8px 10px; border-radius: 6px; border: 1px solid #ddd; margin-bottom: 10px;" value="<?php echo isset($search_products) ? htmlspecialchars($search_products) : '' ?>" placeholder="Nhập tên sản phẩm...">
            </div>
            <div class="sidebar__filter-group">
            ...
            <button type="submit" class="sidebar__filter-btn btn-loc-dep">Lọc</button>
        </form>
...
<style>
    ...
    .btn-loc-dep {
        width: 100%;
        background: linear-gradient(90deg, #e63946 0%, #ffa500 100%);
        color: #fff;
        border: none;
        border-radius: 8px;
        padding: 12px 0;
    ...
    .btn-loc-dep:hover {
        background: linear-gradient(90deg, #ffa500 0%, #e63946 100%);
        color: #fff;
