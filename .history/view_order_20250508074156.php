                                                    ...
                                                    <div class="suggested-products">
                                                        ...
                                                        <div class="suggested-products-list">
                                                            ...
                                                            while($sp = mysqli_fetch_assoc($result)) {
                                                                ...
                                                                echo '<a href="add_to_cart.php?id='.$sp['product_id'].'" class="btn-add-to-cart" style="display:inline-block;margin-top:8px;padding:6px 14px;background:#ffa500;color:#fff;border-radius:4px;text-decoration:none;font-size:14px;">Thêm vào giỏ hàng</a>';
                                                                echo '</div>';
                                                            }
                                                            ?>
                                                        </div>
