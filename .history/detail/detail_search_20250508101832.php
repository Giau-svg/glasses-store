<?php /* Không cần truy vấn lại, chỉ nhận $result, $search_products, $price_range, $brand_id, $category_id từ file cha */ ?>
<!DOCTYPE html>
<html lang="en">
                    ...
                    <div class="row row-category">
                        <?php if(mysqli_num_rows($result) > 0) { ?>
                            <?php while($product = mysqli_fetch_assoc($result)) { ?>
                                <div class="col-4 col-md-4 col-sm-6 mb-4">
                                    <div class="category">
                        ...
                        <div class="sidebar__category">
                            ...
                            <form method="get" action="search.php" style="padding: 0 10px 10px 10px;">
                                ...
                                <div class="sidebar__filter-group">
                                    ...
                                    <select name="category_id" class="sidebar__filter-select">
                                        <option value="">Tất cả</option>
                                        <?php
