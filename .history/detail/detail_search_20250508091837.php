                            ...
                            <?php while ($each = mysqli_fetch_assoc($result)) : ?>
                                <div class="col col-3 col-2-mt mt-10">
                                    <div class="product-card">
                                        <img src="admin/products/uploads/<?php echo $each['image_path'] ?>" alt="<?php echo htmlspecialchars($each['product_name']) ?>" class="product-img">
                                        <h3 class="product-title"><?php echo htmlspecialchars($each['product_name']) ?></h3>
                                        ...
                                        <a href="view_detail.php?id=<?php echo $each['product_id'] ?>" class="btn-buy">Mua ngay</a>
                                    </div>
                                </div>
                            <?php endwhile ?>
                        <?php else: ?>
