                                    ...
                                    <?php foreach ($cart as $product_id => $item) : ?>
                                        <div class="row-table_cart row-cart-js">
                                            <div class="col-table-p col-table-5">
                                                <img height="200" src="admin/products/server/uploads/<?php echo $item['image_path'] ?>" alt="">
                                            ...
                                            <div class="col-table-p col-table-2 col-table-price">
                                                ...
                                                <button class="cart_type btn-cart-delete" data-id="<?php echo $product_id ?>">Xóa</button>
                                            </div>
                ...
                <div class="grid">
                    <div class="row">
                        ...
                        <div class="col col-4 col-mobi" style="flex: 1; min-width: 250px; padding: 0 15px; margin-bottom: 20px;">
                            ...
                            <div class="footer__text" style="color: #666; line-height: 1.6; font-size: 14px;">
                                <p>
                                    <i class="fas fa-phone" style="color: #ffa500; margin-right: 10px;"></i> Phone Sale: <a href="tel:+84901234567" style="color: #666; text-decoration: none;">(+84) 901234567</a>
                                </p>
                                <p>
                                    <i class="fas fa-envelope" style="color: #ffa500; margin-right: 10px;"></i> Email: <a href="mailto:nhom13@saigon.edu.vn" style="color: #666; text-decoration: none;">nhom13@saigon.edu.vn</a>
                                </p>
                            </div>
                        </div>
                    </div>
