                                    ...
                                    <?php foreach ($cart as $id => $each) : ?>
                                        <div class="row-table_cart row-cart-js">
                                            <div class="col-table-p col-table-5">
                                                <img height="200" src="admin/products/server/uploads/<?php echo $each['image_path'] ?>" alt="">
                                        ...
                                        <form class="col-full col-form-order" action="process_checkout.php" method="post">
                                            <div class="row-order">
                                                <div class="col col-3">
                                                    ...
                                                    <input class="form_order" type="text" name="name_receiver" value="<?php echo htmlspecialchars($each['full_name'] ?? ''); ?>">
                                                </div>
                                                <div class="col col-3">
                                                    <label class="label-address" for="">Số điện thoại(bắt buộc)</label>
                                                    <input class="form_order" type="text" name="phone_receiver" value="<?php echo htmlspecialchars($each['phone_number'] ?? ''); ?>">
                                                </div>
                                            </div>
                                            <div class="row-order">
                                                <div class="col col-full">
                                                    <label class="label-address" for="">Địa chỉ người nhận(bắt buộc)</label>
                                                    <input class="form_order" type="text" name="address_receiver" value="<?php echo htmlspecialchars($each['address'] ?? ''); ?>">
                                                </div>
                                            </div>
