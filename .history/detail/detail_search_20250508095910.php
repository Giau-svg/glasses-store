                    ...
                    <?php while ($each = mysqli_fetch_assoc($result)) : ?>
                        <div class="col col-3 col-2-mt mt-10">
                            <div class="product-card">
                                <a href="view_detail.php?id=<?php echo $each['product_id'] ?>" class="product-link">
                                    <div class="product-img-container">
                                        <img src="admin/products/uploads/<?php echo $each['image_path'] ?>" alt="<?php echo htmlspecialchars($each['product_name']) ?>">
                                    </div>
                                    <div class="product-info">
                                        <h4 class="product-name"><?php echo $each['product_name'] ?></h4>
                                ...
                                <div class="product-actions">
                                    ...
                                    <?php if (!empty($_SESSION['id'])) { ?>
                                        <a onclick="return Suc()" href="add_to_cart.php?id=<?php echo $each['product_id'] ?>" class="btn-add-cart">
