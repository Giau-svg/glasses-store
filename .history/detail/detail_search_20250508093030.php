                                    ...
                                    <div class="category">
                                        <a href="view_detail.php?id=<?php echo $each['product_id'] ?>" class="category_link">
                                            ...
                                            <div class="manufacturer-info">
                                                <?php echo $each['brand_name'] ?><br>
                                                Nhà SX: <?php echo $each['brand_name'] ?>
                                            </div>
                                        ...
                                        <div class="category-btn">
                                            <?php if (!empty($_SESSION['customer_id'])) { ?>
                                                <a onclick="return addToCart(<?php echo $each['product_id']; ?>)" href="javascript:void(0)" class="add-to-cart-btn">
                                                    Thêm vào giỏ hàng
                                                </a>
                                            <?php } else { ?>
