            ...
            <div class="grid_full-width">
                ...
                <div class="grid_full-width content">
                                            ...
                                            <div class="col-table col-table-5">
                                                <div class="order-card">
                                                    <div class="order-card-header">
                                                        <div class="order-success-icon" style="background:#ffa500;">
                                                            <i class="fas fa-heart"></i>
                                                        </div>
                                                        <h2>Cảm ơn bạn đã đặt hàng!</h2>
                                                        <p class="order-thankyou">Đơn hàng của bạn đã được ghi nhận.<br>
                                                        Chúng tôi sẽ liên hệ và giao hàng sớm nhất.<br>
                                                        <b>Chúc bạn một ngày tuyệt vời cùng sản phẩm mới!</b></p>
                                                    </div>
                    ...
                    <div class="suggested-products">
                        <h3 style="text-align:center; color:#ffa500; margin:32px 0 18px 0;">Có thể bạn sẽ thích</h3>
                        <div class="suggested-products-list" style="display:flex; gap:24px; justify-content:center; flex-wrap:wrap;">
                            <?php
                            // Lấy 3 sản phẩm ngẫu nhiên hoặc nổi bật
                            $sql = "SELECT * FROM products ORDER BY RAND() LIMIT 3";
                            $result = mysqli_query($connect, $sql);
                            while($sp = mysqli_fetch_assoc($result)) {
                                echo '<div class="suggested-product" style="background:#fff; border-radius:10px; box-shadow:0 2px 8px #eee; padding:12px; width:200px; text-align:center;">';
                                echo '<a href="view_detail.php?id='.$sp['product_id'].'"><img src="admin/products/uploads/'.$sp['image_path'].'" style="width:100%;height:120px;object-fit:cover;border-radius:8px;"></a>';
                                echo '<h4 style="font-size:16px;margin:10px 0 6px 0;">'.$sp['product_name'].'</h4>';
                                echo '<div style="color:#ffa500;font-weight:bold;font-size:16px;">'.number_format($sp['price'],0,',','.').' đ</div>';
                                echo '<a href="view_detail.php?id='.$sp['product_id'].'" style="display:inline-block;margin-top:8px;padding:6px 14px;background:#ffa500;color:#fff;border-radius:4px;text-decoration:none;font-size:14px;">Xem ngay</a>';
                                echo '</div>';
                            }
                            ?>
                        </div>
