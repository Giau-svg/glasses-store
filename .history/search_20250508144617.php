...
echo "<div style='padding: 15px; font-weight: bold;'>Tìm thấy $num_results sản phẩm phù hợp</div>";
        ...
        <div class="product-list">
            ...
            if ($num_results > 0) {
                while ($product = mysqli_fetch_assoc($result)) {
                    // Hiển thị sản phẩm, ví dụ:
                    echo "<div>{$product['product_name']} - {$product['price']}đ</div>";
                }
            } else {
                echo "<div>Không tìm thấy sản phẩm phù hợp.</div>";
            }
            ?>
        </div>
