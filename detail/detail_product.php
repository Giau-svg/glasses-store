...
$sql = "SELECT brands.brand_name as brand, products.* FROM products
                    ...
                    <div class="row">
                        <div class="col col-2">
                            <div class="cart_phone-img">
                                <img src="admin/products/server/uploads/<?php echo $each['image_path'] ?>" alt="">
                            </div>
                        </div>
                        <div class="col col-2">
                            <div class="cart_phone-about">
                                <h2><?php echo $each['product_name'] ?></h2>
                                <span><?php echo $each['description'] ?></span>
                                ...
                                <?php } else { ?>
                                    <a class="cart_phone-btn" href="add_to_cart.php?id=<?php echo $each['product_id'] ?>">Mua ngay</a>
                                <?php } ?>
                            </div>
                        </div>
                    </div>
                ...
                <div class="grid grid-cart_phone">
                    <div class="row">
                        <div class="cart_phone-about">
                            ...
                            <p class="cart_phone-descriptions"><?php echo $each['description'] ?></p>
                        </div>
                    </div>
                </div>
            </div>
