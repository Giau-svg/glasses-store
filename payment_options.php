            ...
            <div class="grid_full-width">
                ...
                <div class="grid">
                    <div class="checkout-flex">
                        <div class="col col-8" style="flex:1; min-width:340px; max-width:520px;">
                            <div class="payment-options">
                                ...
                                <form action="" method="post" id="payment-form">
                                    ...
                                    <div class="payment-option" onclick="selectPayment('cod')">
                                        ...
                                        <div class="payment-icon" style="color: #ffa500; background: #fffbe6;">
                                    ...
                                    <div class="payment-option" onclick="selectPayment('bank_transfer')">
                                        ...
                                        <div class="payment-icon" style="color: #3b82f6; background: #eaf4fb;">
                                    ...
                                    <div class="payment-option" onclick="selectPayment('credit_card')">
                                        ...
                                        <div class="payment-icon" style="color: #a78bfa; background: #f3e8ff;">
                                    ...
                                    <div class="payment-option" onclick="selectPayment('momo')">
                                        ...
                                        <div class="payment-icon" style="color: #e26ee5; background: #f9e6ff;">
                                    ...
                                    <div class="payment-option" onclick="selectPayment('vnpay')">
                                        ...
                                        <div class="payment-icon" style="color: #2563eb; background: #e8f4ff;">
                                    ...
                                    <div class="payment-option" onclick="selectPayment('zalopay')">
                                        ...
                                        <div class="payment-icon" style="color: #10b981; background: #e6f6e6;">
                        ...
                        <div class="col col-4" style="flex:0 0 380px; min-width:320px;">
