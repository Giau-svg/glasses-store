...
<head>
    ...
    <style>
        ...
        .order-success-icon {
            background: #ffe3f0 !important;   /* nền hồng nhạt */
            color: #e75480 !important;        /* trái tim hồng tươi */
            width: 70px;
            height: 70px;
            font-size: 36px;
        ...
        .btn-view-order, .btn.btn-primary {
            background: #43a047 !important;      /* xanh lá dịu */
            color: #fff !important;
        ...
        .btn-view-order:hover, .btn.btn-primary:hover {
            background: #2e7031 !important;      /* xanh lá đậm hơn khi hover */
        }
    </style>
</head>
...
<body>
    <div class="wrapper">
        ...
        <div class="container">
            <div class="grid_full-width">
                ...
                <!-- Đặt khung cảm ơn ở đây, ngay dưới menu -->
                    ...
                    <div class="order-card">
                        ...
                        <div class="order-card-body">
                            <div class="order_success">
                                ...
                                <a href="./info_order.php" class="btn btn-primary">
        ...
        <div class="suggested-products">
            ...
            <div class="suggested-products-list">
                ...
                while($sp = mysqli_fetch_assoc($result)) {
                    ...
                    echo '<img src="admin/products/uploads/'.$sp['image_path'].'" alt="'.$sp['product_name'].'">';
                    echo '<h4>'.$sp['product_name'].'</h4>';
                    echo '<div class="brand">'.$sp['brand_name'].'</div>';
                    echo '<div class="price">'.number_format($sp['price'],0,',','.').' đ</div>';
                    echo '<a href="add_to_cart.php?id='.$sp['product_id'].'" class="btn-add-to-cart">Thêm vào giỏ hàng</a>';
                    echo '</div>';
                }
                ?>
            </div>
    ...
    <!-- Dán mã Chatbase ở đây -->
    <script>
    (function(){if(!window.chatbase||window.chatbase("getState")!=="initialized"){window.chatbase=(...arguments)=>{if(!window.chatbase.q){window.chatbase.q=[]}window.chatbase.q.push(arguments)};window.chatbase=new Proxy(window.chatbase,{get(target,prop){if(prop==="q"){return target.q}return(...args)=>target(prop,...args)}})}const onLoad=function(){const script=document.createElement("script");script.src="https://www.chatbase.co/embed.min.js";script.id="J7-J_NgOzZGBE4mLCIg-N";script.domain="www.chatbase.co";document.body.appendChild(script)};if(document.readyState==="complete"){onLoad()}else{window.addEventListener("load",onLoad)}})();
    </script>
</body>
