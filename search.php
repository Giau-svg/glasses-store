                    ...
                    <div class="content__brands">
                        <div class="grid">
                            ...
                            <div class="search-result-info">
                                <?php
                                echo "Tìm thấy $num_results sản phẩm";
                                if ($search_products) echo " cho từ khóa <b>\"$search_products\"</b>";
                                if ($brand) echo " | Thương hiệu: <b>$brand</b>";
                                if ($category) echo " | Danh mục: <b>$category</b>";
                                if ($price) echo " | Giá: <b>$price</b>";
                                ?>
                            </div>
                        </div>
                        <!-- Danh sách sản phẩm -->
