...
// Xây dựng tiêu đề trang dựa trên thương hiệu và loại sản phẩm
$page_title = '';
if (!empty($brand_name) && !empty($category_name)) {
    $page_title = $brand_name . ' - ' . $category_name;
        ...
        <main class="container" style="padding-top: 20px; margin-top: 0;">
            <div class="grid_full-width">
                <div class="grid_full-width content">
                    ...
                    <?php include './partials/slidebar_category.php' ?>
                </div>
            </div>
        </main>
