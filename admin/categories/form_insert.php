...
$id_field = (mysqli_num_rows($result_check) > 0) ? 'category_id' : 'id';
                                    ...
                                    <div class="col-md-8">
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <select class="form-control" name="type" id="type">
                                                <option value="men">Kính Nam (men)</option>
                                                <option value="women">Kính Nữ (women)</option>
                                                <option value="sunglasses">Kính Mát (sunglasses)</option>
                                                <option value="children">Kính Trẻ Em (children)</option>
                                    ...
                                    <div class="col-md-4">
                                        <div class="mb-3">
                                            ...
                                            <div class="image-preview mb-3">
                                                <img src="../public/img/no-image.png" alt="Preview" id="preview-image" class="img-fluid">
                                            </div>
                                            <input type="file" class="form-control" id="image" name="image" accept="image/*">
                                            <small class="form-text text-muted">Chọn hình ảnh cho danh mục (JPG, PNG, GIF)</small>
                                        </div>
                                    </div>
                                </div>
