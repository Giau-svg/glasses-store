...
$pagination = new Pagination($page, $records_per_page, $total_records);
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        ...
                        <div>
                            ...
                            <button class="btn btn-sm btn-success shadow-sm ml-2" id="exportExcel">
                        ...
                        <div class="card-body">
                            <form method="GET" action="" class="row">
                                ...
                                <div class="col-12 text-right">
                                    ...
                                    <a href="stock_reports.php" class="btn btn-secondary ml-2">
                            ...
                            <div class="d-flex justify-content-center mt-4">
                                <nav aria-label="Page navigation">
                                    <ul class="pagination">
                                        <?php if ($page > 1): ?>
                                            <li class="page-item">
<a class="page-link" href="?page=<?php echo $pagination->getPreviousPage(); ?>&category=<?php echo urlencode($category); ?>&stock_quantity_status=<?php echo urlencode($stock_quantity_status); ?>&sort_by=<?php echo urlencode($sort_by); ?>&search=<?php echo urlencode($search); ?>" aria-label="Previous">
     Previous
</a>
                                            </li>
                                        <?php endif; ?>
                                        ...
                                        <?php if ($page < $total_pages): ?>
                                            <li class="page-item">
                                            <a class="page-link" href="?page=<?php echo $pagination->getNextPage(); ?>&category=<?php echo urlencode($category); ?>&stock_quantity_status=<?php echo urlencode($stock_quantity_status); ?>&sort_by=<?php echo urlencode($sort_by); ?>&search=<?php echo urlencode($search); ?>" aria-label="Next">
    Next
</a>
                                            </li>
                                        <?php endif; ?>
