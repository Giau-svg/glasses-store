...
$where_conditions = ["o.order_status != 'cancelled'"]; // Loại bỏ đơn hàng đã bị hủy
if (!empty($search)) {
    $search_escaped = mysqli_real_escape_string($connect, $search);
    $where_conditions[] = "(o.order_id LIKE '%$search_escaped%' OR o.shipping_name LIKE '%$search_escaped%' OR o.shipping_phone LIKE '%$search_escaped%')";
}
                        ...
                        <div class="card-body">
                            <form method="get" class="form-inline">
                                <div class="form-group mx-sm-3 mb-2">
                                    ...
                                    <input type="text" class="form-control" id="search" name="search" placeholder="Nhập mã hóa đơn" value="<?php echo htmlspecialchars($search ?? ''); ?>">
                                </div>
                                <div class="form-group mx-sm-3 mb-2">
                                    ...
                                    <select class="form-control" id="status" name="status">
                                        ...
                                        <option value="shipping" <?php echo ($status_filter == 'shipped') ? 'selected' : ''; ?>>Đang giao hàng</option>
                                ...
                                <a href="order_history.php" class="btn btn-secondary mb-2 ml-2">
