...
// Lấy danh sách đơn hàng có trạng thái "chờ xử lý" hoặc "đang xử lý"
...
$sqlCount = "SELECT COUNT(*) as total FROM orders o WHERE o.order_status IN ('pending', 'processing')";
